...
[TestClass]
public sealed class FastPortTestSmokeServerTests
{
    [TestMethod]
    public async Task FastPortTestSmokeServer_FixedPayload_EchoesAndRecordsTelemetry()
    {
        await using FastPortTestSmokeServerTestHost server = await FastPortTestSmokeServerTestHost.StartAsync();
    ...
    [TestMethod]
    public async Task FastPortTestSmokeServer_RandomLargePayload_EchoesAndRecordsTelemetry()
    {
        await using FastPortTestSmokeServerTestHost server = await FastPortTestSmokeServerTestHost.StartAsync();
    ...
    private sealed class FastPortTestSmokeServerTestHost : IAsyncDisposable
    {
        private readonly IHost _host;

        private FastPortTestSmokeServerTestHost(
            IHost host,
            int port,
            IServerTelemetry telemetry,
        ...
        public static async Task<FastPortTestSmokeServerTestHost> StartAsync()
        {
            ...
            IHost host = Host.CreateDefaultBuilder()
                ...
                .ConfigureServices(services =>
                {
                    ...
                    services.AddSingleton<IClientSessionFactory, FastPortTestSmokeServer.Sessions.FastPortTestSmokeClientSessionFactory>();
            ...
            var server = new FastPortTestSmokeServerTestHost(host, port, telemetry, telemetryExporter);
        ...
        private async Task WaitUntilReadyAsync()
        {
            ...
            throw new TimeoutException($"FastPortTestSmokeServer did not become ready on port {Port}.");
        }
