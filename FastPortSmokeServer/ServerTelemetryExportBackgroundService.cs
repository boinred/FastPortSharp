...
public sealed class ServerTelemetryExportBackgroundService : BackgroundService
{
    ...
    private readonly FastPortSmokeServerTelemetryOptions _options;
    ...
    public ServerTelemetryExportBackgroundService(
        ...
        FastPortSmokeServerTelemetryOptions options)
    {
        _logger = logger;
        _exporter = exporter;
        _options = options;
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        TimeSpan interval = TimeSpan.FromSeconds(Math.Max(1, _options.IntervalSeconds));
