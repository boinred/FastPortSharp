    ...
    MetricsCollector metricsCollector)
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        catch (OperationCanceledException) when (sessionCancellation.IsCancellationRequested && !sendTask.IsFaulted && !receiveTask.IsFaulted)
        {
        }
    }
    ...
    private async Task SendLoopAsync(NetworkStream stream, CancellationToken cancellationToken)
    {
        ...
        while (!cancellationToken.IsCancellationRequested)
        {
            ...
            try
            {
                ...
                {
                    metricsCollector.RecordOperationDuration("send-write", Stopwatch.GetElapsedTime(writeStartedAt));
                }
